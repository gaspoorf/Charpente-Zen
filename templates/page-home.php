...
<section class="beige pad3 pad-bot">
    ...
    <div class="section-second">
        ...
        <div id="about-infos" class="section-first-content simple-center">
...
<section class="white pad3 pad-bot">
    ...
    <div class="simple-center">
        <div>
            ...
            <h2><?php echo ($prestations_title);?></h2>
        </div>
    </div>
    <div class="slider">
        <div class="cards"> 
...
<section class="beige pad3 pad-bot">
    <div class="simple-center">
        <div>
            <h3><?php echo ($review_section_title);?></h3>
...
<section class="white pad3 pad-bot">
    <div class="simple-center">
        <div>
            <h3><?php echo ($partners_section_title);?></h3>
